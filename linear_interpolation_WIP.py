...
""" WAITTTTT MAYBE I NEED TO INTRODUCE A DIFFERENT INTEGER FOR THE 300 MINUTE MARK??? SINCE THE ISS ORBITS THE EARTH EVERY 90 MINUTES SHOULDNT I SUBTRACT FROM A SOME NUMBER OF ORBITS....???

my thinking is that since there are a total of 3 orbits + 30 minutes, I should actually use t_300 = 30. maybe that would fix the issue???? """